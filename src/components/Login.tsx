...
import { ILoginFormAttributes } from '@app/store/models';
...
const Login: React.FC<FormikProps<ILoginFormAttributes>> = ({
  ...
  FormState[AUTH_STEP_SIGNIN] = (
    <>
      ...
      <input type="password" onChange={handleChange} onBlur={handleBlur} value={values.password} name="password" />
  ...
  FormState[AUTH_STEP_CONFIRM_SIGNIN] = (
    <>
      <input type="text" onChange={handleChange} onBlur={handleBlur} value={values.code} name="code" />
